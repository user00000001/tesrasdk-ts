 ...
 */
export declare function makeRegisterCandidateTx(tstId: string, peerPubKey: string, keyNo: number, userAddr: Address, initPos: number, payer: Address, gasPrice: string, gasLimit: string): Transaction;
/**
 *
...
export declare function makeWithdrawPeerUnboundTsgTx(userAddr: Address, payer: Address, gasPrice: string, gasLimit: string): Transaction;
/**
...
export declare function getPeerUnboundTsg(userAddr: Address, url?: string): Promise<number>;
export declare function getConfiguration(url?: string): Promise<Configuration>;
/**
