...
export declare class SDK {
    ...
    static createTWallet(name: string, password: string, payer: string, gasPrice: string, gasLimit: string, callback?: string): Promise<any>;
    ...
    static importIdentityWithTWallet(label: string, encryptedPrivateKey: string, password: string, address: string, salt: string, callback?: string): any;
    static importIdentityAndCreateTWallet(label: string, encryptedPrivateKey: string, password: string, address: string, salt: string, callback?: string): Promise<any>;
    ...
    static importAccountWithTWallet(label: string, encryptedPrivateKey: string, address: string, salt: string, password: string, callback?: string): {
        error: ERROR_CODE;
        result: string;
    };
    static signSelfClaim(context: string, claimData: string, tstId: string, encryptedPrivateKey: string, password: string, address: string, salt: string, callback?: string): {
        error: ERROR_CODE;
        result: string;
    } | {
        error: number;
    ...
    static claimTsg(address: string, value: string, encryptedPrivateKey: string, password: string, salt: string, gasPrice: string, gasLimit: string, payer: string, callback?: string): {
        error: ERROR_CODE;
        result: string;
    };
    ...
    static getUnclaimedTsg(address: string, callback?: string): Promise<{
        error: ERROR_CODE;
        result: any;
    } | {
        error: any;
    ...
    static createSharedTWallet(requiredSignatureNum: string, allRelatedPks: string, callback?: string): string;
